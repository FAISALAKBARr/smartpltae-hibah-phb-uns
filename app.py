...
/* Intro text — pakai --text-color Streamlit, otomatis cerah di dark mode */
.intro-text {
...
st.markdown("""
<p class="intro-text">
SmartPlate adalah platform <em>end-to-end</em> untuk mendukung keseimbangan gizi masyarakat Indonesia.
